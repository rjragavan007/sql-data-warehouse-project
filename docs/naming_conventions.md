...
* **Style:** Use `snake_case`, with lowercase letters and underscores (`_`) to separate words.
...
* **Pattern:** `load_<layer>`
  ...
  * *Examples:* 
    ...
    * `load_gold` $\rightarrow$ Stored procedure for loading data into the Gold layer.
